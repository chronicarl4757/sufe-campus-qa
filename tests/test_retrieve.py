...
def test_publisher_college():
    from sufe_qa.retrieve.retriever import _publisher_college
...
def test_search_named_college_ranks_that_college_first(settings):
    """点名学院时该院文档不被降权，压过内容相同的其他学院文档（authority_weight 命名豁免）。"""
